...
export default defineConfig({
  ...
  themeConfig: {
    ...
    nav: [
      { text: "组件库", link: "/content/components/" },
      { text: "启动页", link: "/content/welcome/" },
      ...
      { text: "关于我们", link: "/content/about/index" },
    ],
    ...
    sidebar: {
      "content/components/": [
        ...
        },
        {
          ...
          items: [
            ...
            {
              text: "Divider 分割线",
              link: "/content/components/cu_divider",
            },
          ],
        },
        {
          ...
          items: [
            ...
            {
              text: "Checkbox 多选框",
              link: "/content/components/cu_checkbox",
            },
            ...
            {
              text: "Multi Select 多选",
              link: "/content/components/cu_multi_select",
            },
          ],
        },
        {
          ...
          items: [
            ...
            {
              text: "AppBar 导航栏",
              link: "/content/components/cu_appbar",
            },
            {
              text: "TabBar 底部导航",
              link: "/content/components/cu_tabbar",
            },
            { text: "Tabs 标签页", link: "/content/components/cu_tabs" },
            {
              text: "KeepAlive 保活",
              link: "/content/components/cu_keep_alive",
            },
          ],
        },
        {
          ...
          items: [
            ...
            {
              text: "Result 结果页",
              link: "/content/components/cu_result",
            },
            {
              text: "Progress Circle 圆形进度条",
              link: "/content/components/cu_progress_circle",
            },
        ...
        },
        {
          ...
          items: [
            {
              text: "Dialog 对话框",
              link: "/content/components/cu_dialog",
            },
            {
              text: "Confirm 确认框",
              link: "/content/components/cu_confirm",
            },
            { text: "Toast 轻提示", link: "/content/components/cu_toast" },
            {
              text: "Loading 加载",
              link: "/content/components/cu_loading",
            },
            {
              text: "Bottom Sheet 底部抽屉",
              link: "/content/components/cu_bottom_sheet",
            },
            {
              text: "Refresh 刷新",
              link: "/content/components/cu_refresh",
            },
            {
              text: "Upgrade 应用更新",
              link: "/content/components/cu_upgrade",
            },
          ],
        }],
      "content/welcome/": [
        { text: "使用及规范", link: "/content/welcome/index" },
        { text: "隐私合规", link: "/content/welcome/privacy-compliance" },
      ],
      "/content/theme/": {
        text: "主题系统",
        items: [
      ...
      "/content/api/": {
        ...
        items: [
          ...
          { text: "适配 Cool-Admin 后台框架", link: "/content/api/admin" },
    ...
    editLink: {
      text: "在Gitee上编辑",
      pattern: "https://gitee.com/curb-ui/curb-ui-docs/blob/master/:path",
    },
    footer: {
      message:
        '联系邮箱: <a href="mailto:curbui@yeah.net">curbui@yeah.net</a> | <a href="/content/about/agreement">用户服务协议</a> | <a href="/content/about/privacy">隐私政策</a> | Released under the MIT License.',
